        ...
        <div class="row">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/schools/create') }}" class="btn btn-success btn-sm" title="Add New School">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Description</th><th>Teachers</th><th>Actions</th>
                                    </tr>
                                </thead>
                                ...
                                @foreach($schools as $item)
                                    <tr>
                                        ...
                                        <td><p style="width:65px; overflow: hidden">{{ $item->title }}</p></td>
                                        <td><p style="width:120px; overflow: hidden">{{ $item->description }}</p></td>
                                        <td><p style="width:160px; overflow: hidden">{{ $item->teachers }}</p></td>
                                        <td>
